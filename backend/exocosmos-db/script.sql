...
VALUES (1, 'Terrestrial', 0, 4, 0, 2, 0, 1, 3),
...
INSERT INTO `compounds` (`CID`, `name`, `formula`)
VALUES (176, 'Acetic Acid', 'C2H4O2'),
    (222, 'Ammonia', 'H3N'),
    (241, 'Benzene', 'C6H6'),
    (280, 'Ammonia', 'NH3'),
    ...
    (
        166755,
        '2,7-Naphthalenedisulfonic acid, 4-(2-(4-(2-(4-amino-1-naphthalenyl)diazenyl)-1-naphthalenyl)diazenyl',
        'C30H19N5Na2O6S2'
    ),
    (
        170510,
    ...
    (
        439200,
        '[[(2R,3S,4R,5R)-5-(6-amino-7H-purin-9-ium-9-yl)-3,4-dihydroxyoxolan-2-yl]methoxy-hydroxyphosphoryl] ',
        'C15H24N5O14P2+'
    ),
    ...
    (
        15972344,
        'Ethynylbenzene;methyl(triphenyl)phosphanium;1,2,3,4,5-pentafluorobenzene-6-ide;platinum(2+)',
        'C66H46F10P2Pt'
    ),
    (
        15976549,
        '(2S)-2-[[(4R)-17-[methyl(methylsulfonyl)amino]-2-oxo-3-azatricyclo[13.3.1.16,10]icosa-1(18),6,8,10(2',
        'C31H42N4O4S'
    ),
    (
        16217398,
    ...
    (
        56843091,
        'Calcium aluminosilicate (CaAl2Si2O8)',
        'Al2CaO8Si2'
    ),
